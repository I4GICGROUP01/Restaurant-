...
<html>
<head>
    <title>Lunch-Monalisa Restuarant</title>
            ...
            <ul class="nav  navbar-right nav nav-pills">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="lunch.php">Lunch</a></li>
                        <li role="separator" class="divider"></li>
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    ...
                    <p class="slideshowtext">Monalisa Lunch</p>
                    <h1>OUR MENU</h1>
                </div>
            </div>
...
<center>
    <div class="wow bounceInDown" data-wow-delay="0.6s">
        <p class="topwriter">
        <h1 class="topwriter"> WELCOME TO LUNCH MENU </h1>
        </p>
    </div>
</center>
<br>
<!-- Living Cambodia Cuisine-->
<div class="container wow slideInLeft" data-wow-delay="0.8s">
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 wow slideInLeft" data-wow-delay="0.8s">
            <div class="thumbnail">
        ...
        <div class="col-sm-6 col-md-4 wow slideInRight" data-wow-delay="0.8s">
            <div class="thumbnail">
        ...
        <div class="col-sm-6 col-md-4 wow slideInRight" data-wow-delay="0.8s">
            <div class="thumbnail">
                ...
                <div class="caption">
                    <p class="writer">Praw Soup Lemongras:..........15$</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4 wow slideInLeft" data-wow-delay="0.8s">
